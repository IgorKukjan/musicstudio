...
public class ConnectionPool {
    ...
    //2 очереди
    //Свободное соединение и отданные соединения
    //2-я создана для контроля целосности пула соединений
    //    //В любой момент можно остановить выдачу connection - ов
    //И проверить контрольную сумму, чтобы сумма connection-ов, содержащихся
    //в обоих очередях была 8, если задан размер пула соединений 8
    //В случае, если контрольная сумма не совпадает, значит происходит утечка соединний
    //
    ...
    //Инициализация параметров пула соединений
    //Инициализируем очереди и заполняем их соединениями
